...
const EditTicketModal: FC<EditTicketModalProps> = ({ eventId, eventTitle, refetchEvents, ticket, onClose }) => {
...
// const EditTicketModal: FC<EditTicketModalProps> = ({ eventId, eventTitle, refetchEvents }) => {
